...
**Report Period:** Last 7 days (generated July 13, 2026 at 10:51 UTC)

## Weekly Release Summary by Vendor

> **10 breaking change(s) detected** across 14 total releases. Review the sections below for details.
>
...
| Amazon EKS | 10 | 8 (Sensor: 8) | **Action needed** |
| Azure AKS | 0 | 0 | No updates |
| Google GKE | 3 | 2 | **Action needed** |
...
- **Severity:** HIGH
- **Component:** GKE
- **Details:** [View full release notes](https://docs.cloud.google.com/kubernetes-engine/docs/release-notes#July_09_2026)
...
- **Severity:** MEDIUM
- **Component:** GKE
- **Details:** [View full release notes](https://docs.cloud.google.com/kubernetes-engine/docs/release-notes#July_10_2026)
