...
**Report Period:** Last 7 days (generated June 29, 2026 at 12:24 UTC)

## Weekly Release Summary by Vendor

> **15 breaking change(s) detected** across 17 total releases. Review the sections below for details.
>
> **Qualys Sensor Impact:** 13 release(s) contain changes that may affect sensor connectivity (token/auth, kubeapi, runtime, DaemonSet).
...
| Red Hat OpenShift | 4 | 4 (Sensor: 4) | **Action needed** |
